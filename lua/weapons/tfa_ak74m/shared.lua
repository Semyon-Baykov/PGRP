...
SWEP.PrintName				= "АК74М"		-- Weapon name (Shown on HUD)	
...
SWEP.VMPos = Vector(0,1,-1) --The viewmodel positional offset, constantly.  Subtract this from any other modifications to viewmodel position.
...
SWEP.ViewModel				= "models/weapons/v_rif_ak74m.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_rif_ak74m.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("aks74_y-1.wav")		-- Script that calls the primary fire sound
...
SWEP.Secondary.IronFOV			= 63		-- How much you 'zoom' in. Less is more! 	
...
SWEP.IronSightsPos = Vector(3.11, 0, 1.06)
SWEP.IronSightsAng = Vector(-3, 0, 0)
SWEP.SightsPos = Vector(3.11, 0, 1.06)
SWEP.SightsAng = Vector(-3, 0, 0)
SWEP.RunSightsPos = Vector (-7, -4, -2)
SWEP.RunSightsAng = Vector (0, -53, 0)
SWEP.InspectPos = Vector(-6, -4, -1)
SWEP.InspectAng = Vector(0, -53, 0)
