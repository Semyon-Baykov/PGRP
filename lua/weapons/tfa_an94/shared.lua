...
SWEP.Gun = ("tfa_an94") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "АН-94"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(2.4, 0, 1.46)
SWEP.IronSightsAng = Vector(-1, 2, 0)
SWEP.RunSightsPos = Vector(-8.681, -8, 0.4)
SWEP.RunSightsAng = Vector(-7.2, -60, 0)
SWEP.RunSightsPos = Vector(-8.681, -8, 0.4)
SWEP.RunSightsAng = Vector(-7.2, -60, 0)
