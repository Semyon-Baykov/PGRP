...
SWEP.Gun = ("tfa_honeybadger") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_aacbadger.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_aac_honeybadger.mdl"	-- Weapon world model
