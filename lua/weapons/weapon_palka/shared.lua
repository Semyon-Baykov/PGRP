...
SWEP.ViewModel			= "models/weapons/v_palka.mdl"
SWEP.WorldModel			= "models/weapons/w_palka.mdl"
...
local SwingSound = Sound( "weapon_palka.Slash" )
local HitSoundWorld = Sound( "weapon_palka.HitWall" )
local HitSoundBody = Sound( "weapon_palka.Hit" )
...
function SWEP:PrimaryAttack()
	...
	timer.Create("hitdelay", 0.5, 1, function() self:Hitscan() end)
...
//if break
		break
//if end
		//else vm:SendViewModelMatchingSequence( vm:LookupSequence( "stab_miss" ) )
		end
end
...
function SWEP:Deploy()
	...
	self:EmitSound( "weapon_palka.Deploy" )
