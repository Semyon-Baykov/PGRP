...
SWEP.PrintName				= "АКС74У"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_er_ak74u.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_er_ak74u.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("ak47-1.wav")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector (2.72, 0, 0.439)
SWEP.SightsAng = Vector (-0.139, -1.497, 0)
SWEP.RunSightsPos = Vector(-4.02, -2.814, -1.005)
SWEP.RunSightsAng = Vector(-24.623, -52.764, 20.402)
SWEP.InspectPos = Vector(-4.02, -2.814, -1.005)
SWEP.InspectAng = Vector(-24.623, -52.764, 20.402)
SWEP.Offset = {
        Pos = {
        Up = -1,
        Right = 1,
