...
SWEP.Gun = ("tfa_m416") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_hk416rif.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_hk_416.mdl"	-- Weapon world model
