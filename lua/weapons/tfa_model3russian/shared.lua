...
SWEP.Gun = ("tfa_model3russian") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_pist_model3.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_model_3_rus.mdl"	-- Weapon world model
