...
SWEP.Gun = ("tfa_m29satan") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_pist_satan2.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_m29_satan.mdl"	-- Weapon world model
