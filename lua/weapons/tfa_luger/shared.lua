...
SWEP.Gun = ("tfa_luger") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_p08_luger.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_luger_p08.mdl"	-- Weapon world model
