SWEP.Gun = ("tfa_browning_hp") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "Browning Hi-Power"		-- Weapon name (Shown on HUD)		
...
SWEP.WorldModel				= "models/weapons/w_baseplategsh18.mdl"
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("weapons/baseplategsh18/baseplategsh18shoot.wav")
SWEP.Primary.RPM			= 500			-- This is in Rounds Per Minute
SWEP.Primary.ClipSize			= 13		-- Size of a clip
SWEP.Primary.DefaultClip		= 26		-- Bullets you start with
...
SWEP.IronSightsPos = Vector(-2.243, -2.494, 0.416)
SWEP.IronSightsAng = Vector(0.693, 0, 0)
SWEP.SightsPos = Vector(-2.243, -2.494, 0.416)
SWEP.SightsAng = Vector(0.693, 0, 0)
