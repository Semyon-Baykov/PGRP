...
SWEP.Gun = ("tfa_tar21") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_imi_tavor.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_imi_tar21.mdl"	-- Weapon world model
