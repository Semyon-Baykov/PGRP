...
SWEP.PrintName				= "АКС74"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_er_aks74.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_er_aks74.mdl"	-- Weapon world model
...
SWEP.SightsPos = Vector(-2.52, -2, 0.56)
SWEP.SightsAng = Vector(0.14, -0.071, 0)
