...
SWEP.PrintName				= "АК-47"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_v_dot_ak47.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_ak47_tfa.mdl"	-- Weapon world model
