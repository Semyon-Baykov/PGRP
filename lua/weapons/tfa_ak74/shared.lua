...
SWEP.Gun = ("tfa_ak74") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "АК-74"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_v_tct_ak47.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_tct_ak47.mdl"	-- Weapon world model
...
SWEP.Primary.RPM			= 590			-- This is in Rounds Per Minute
...
SWEP.IronSightsPos = Vector(2.039, -1, 0.855)
SWEP.IronSightsAng = Vector(0.23, 0, 0)
SWEP.SightsPos = Vector(2.039, -1, 0.855)
SWEP.SightsAng = Vector(0.23, 0, 0)
