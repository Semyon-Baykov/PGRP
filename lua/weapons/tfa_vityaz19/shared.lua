...
SWEP.Gun = ("tfa_vityaz19") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "ПП-19-01 «Витязь»"		-- Weapon name (Shown on HUD)	
...
SWEP.IronSightsPos = Vector(-3.116, -4.801, 1.1)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-3.116, -4.801, 1.1)
SWEP.SightsAng = Vector(0, -0, 0)
SWEP.RunSightsPos = Vector(1.529, -5.126, -0.401)
