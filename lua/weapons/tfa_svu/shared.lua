...
SWEP.Gun = ("tfa_svu") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "СВУ"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_v_sniper_svu.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_dragunov_svu.mdl"	-- Weapon world model
...
SWEP.IronSightsPos = Vector(-3.24, -2, 0.88)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-3.24, -2, 0.88)
