...
SWEP.Gun = ("tfa_svt40") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "СВТ 40"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_v_snip_svt40.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_svt_40.mdl"	-- Weapon world model
...
SWEP.IronSightsPos = Vector(-3.462, -3, 0.079)
SWEP.IronSightsAng = Vector(0, 0, 0)
SWEP.SightsPos = Vector(-3.462, -3, 0.079)
...
SWEP.ScopeOverlayTransforms = { 0, -10 }
