...
SWEP.PrintName				= "АКС74 без приклада"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_rif_aks74_y.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_rif_aks74_y.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("er_aks.wav")		-- Script that calls the primary fire sound
SWEP.Primary.RPM			= 585			-- This is in Rounds Per Minute
...
SWEP.SightsPos = Vector(-2.681, 0, 0.639)
