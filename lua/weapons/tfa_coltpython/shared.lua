...
SWEP.Gun = ("tfa_coltpython") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_pist_python.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_colt_python.mdl"	-- Weapon world model
