...
SWEP.Gun = ("tfa_vector") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_kriss_svs.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_kriss_vector.mdl"	-- Weapon world model
...
SWEP.Primary.RPM			= 830			-- This is in Rounds Per Minute
