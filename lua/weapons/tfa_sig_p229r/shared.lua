...
SWEP.Gun = ("tfa_sig_p229r") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_sick_p228.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_sig_229r.mdl"	-- Weapon world model
