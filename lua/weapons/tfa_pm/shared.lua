...
SWEP.PrintName				= "ПМ"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_pist_erpm.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_pist_erpm.mdl"	-- Weapon world model
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound			= Sound("pmfire.wav")		-- Script that calls the primary fire sound
...
SWEP.SightsPos = Vector(-1.826, -1.721, 0.56)
SWEP.SightsAng = Vector(0.899, 0, 0)
SWEP.RunSightsPos = Vector (1.24, -7.64, -7.04)
SWEP.RunSightsAng = Vector (58.599, -2.901, 0)
SWEP.InspectPos = Vector(6.039, 0, 1.36)
SWEP.InspectAng = Vector(8.1, 20.5, 28.1)
