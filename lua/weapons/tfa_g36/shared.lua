...
SWEP.Gun = ("tfa_g36") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_rif_g362.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_hk_g36c.mdl"	-- Weapon world model
