...
SWEP.Gun = ("tfa_vikhr") -- must be the name of your swep but NO CAPITALS!
...
SWEP.PrintName				= "СР-3 «Вихрь»"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/tfa_v_dmg_vikhr.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_dmg_vikhr.mdl"	-- Weapon world model
