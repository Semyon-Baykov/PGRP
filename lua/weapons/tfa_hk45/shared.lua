...
SWEP.Gun = ("tfa_hk45") -- must be the name of your swep but NO CAPITALS!
...
SWEP.ViewModel				= "models/weapons/tfa_v_pist_hk45.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/tfa_w_hk45c.mdl"	-- Weapon world model
