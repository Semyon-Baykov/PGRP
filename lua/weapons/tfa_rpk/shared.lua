...
SWEP.MoveSpeed = 0.87 --Multiply the player's movespeed by thi
...
SWEP.Primary.SpreadIncrement = 1/0.3 --What percentage of the modifier is added on, per shot.  Example val: 1/3.5
SWEP.Primary.SpreadRecovery = 30--How much the spread recovers, per second. Example val: 3
...
SWEP.PrintName				= "РПК"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel				= "models/weapons/v_erectangle_rp.mdl"	-- Weapon view model
SWEP.WorldModel				= "models/weapons/w_erectangle_rp.mdl"	-- Weapon world model
...
SWEP.Primary.Sound			= Sound("er_rpk.wav")		-- Script that calls the primary fire sound
...
SWEP.IronSightsPos = Vector(-1.721, 3, 0.37)
SWEP.IronSightsAng = Vector(2.223, -0.057, 0)
