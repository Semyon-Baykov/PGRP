...
SWEP.PrintName				= "АКМ"		-- Weapon name (Shown on HUD)	
...
SWEP.ViewModel			= "models/weapons/matts_akm/v_akm_matt.mdl"
SWEP.WorldModel			= "models/weapons/matts_akm/w_akm_matt.mdl"
SWEP.Base				= "tfa_gun_base"
SWEP.Spawnable				= true
SWEP.AdminSpawnable			= true
SWEP.FiresUnderwater = false

SWEP.Primary.Sound 			= Sound("weapons/akm/fire-1.wav")				-- This is the sound of the weapon, when you shoot.
...
SWEP.IronSightsPos = Vector(-2, 0, 0.28)--Change this, using SWEP Creation Kit preferably
SWEP.IronSightsAng = Vector (0,0,0) --Change this, using SWEP Creation Kit preferably
SWEP.RunSightsPos = Vector(0, 0, 0)
SWEP.RunSightsAng = Vector(-14.775, 18.995, 0)
SWEP.InspectPos = Vector(-5.14, 3.216, 0.159)
SWEP.InspectAng = Vector(0, 0, -56.281)
