...
sound.Add({
	...
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/pigg_m1911/fire.wav"
})

sound.Add({
	name = 			"M1911_Pig.Slideback",
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/pigg_m1911/slideback.wav"
})

sound.Add({
	name = 			"M1911_Pig.Clipout",
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/pigg_m1911/clipout.wav"
})

sound.Add({
	name = 			"M1911_Pig.Clipin",
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/pigg_m1911/clipin.wav"
})

sound.Add({
	name = 			"M1911_Pig.Deploy",
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/pigg_m1911/deploy.wav"
})

sound.Add({
	name = 			"M1911_Pig.Hammertime",
	channel = 		CHAN_USER_BASE+10,
	volume = 		1.0,
	sound = 			"weapons/pigg_m1911/hammertime.wav"
})
