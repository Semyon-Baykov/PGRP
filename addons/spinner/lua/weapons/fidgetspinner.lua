...
SWEP.Category 			= "Other"
SWEP.Instructions 		= "This turns. That's what you should know."
SWEP.Purpose 			= ""
SWEP.Spawnable 			= true
...
SWEP.WElements = {
	["fidgetspinner"] = { type = "Model", model = "models/weapons/w_fidget_spinner.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.7, 1.2, -2), angle = Angle(20, 174.156, 90), size = Vector(0.4, 0.4, 0.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {} }
}
...
function SWEP:PrimaryAttack()
	...
	timer.Simple(.4, function()
		if !IsValid(self) or !IsValid(self.Owner) then return end
		local convarval = GetConVar("fidgetspinner_soundeffects"):GetInt()
		if convarval != 0 then self.Owner:EmitSound("fidget_spinner_sound") end
	end)
end
