...
local function MergePorts(ent_ports, names, types, descs)
	types = types or {}
	descs = descs or {}
...
function WireLib.AddSpecialInputs(ent, names, types, descs)
	...
	names, types, descs = MergePorts(ent.Inputs, names, types, descs)
