...
CH_Bitminers.Config.RateUpdateInterval = 1500 -- Default 20. So it will randomize the change between -20 to +20. So it can either go down or up, but maximum 20 either way.
CH_Bitminers.Config.MinBitcoinRate = 4001 -- The lowest the bitcoin rate can hit.
CH_Bitminers.Config.MaxBitcoinRate = 15001 -- The maximum the bitcoin rate can go to.
...
CH_Bitminers.Config.WattsRequiredPerMiner = 1199 -- Amount of watts required per miner in order to properly mine bitcoins most optimal

CH_Bitminers.Config.ShelfHealth = 100 -- Amount of health before it destroys.
...
CH_Bitminers.Config.GeneratorWattsMin = 15 -- Minimum amounts of watts generated per interval
...
CH_Bitminers.Config.SolarPanelWattsMin = 39 -- Minimum amounts of watts generated per interval
CH_Bitminers.Config.SolarPanelWattsMax = 139 -- Maximum amounts of watts generated per interval (IT'S RANDOMIZED)
...
CH_Bitminers.Config.RTGWattsMin = 99 -- Minimum amounts of watts generated per interval
CH_Bitminers.Config.RTGWattsMax = 249 -- Maximum amounts of watts generated per interval (IT'S RANDOMIZED)
...
CH_Bitminers.Config.TempToAddPerMiner = 0.5 -- Temperature added per miner on the shelf.

CH_Bitminers.Config.TempToTakePerCooling = 1 -- Temperature removed from shelf per cooling upgrade installed.
CH_Bitminers.Config.TempToTakeWhenOff = 5 -- Temperature to remove every interval if the shelf is turned off.
...
-- 3RD PARTY SUPPORT
CH_Bitminers.Config.CreateFireOnExplode = true -- ONLY WORKS WITH MY FIRE SYSTEM https://www.gmodstore.com/market/view/302
