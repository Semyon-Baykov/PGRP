...
CH_Bitminers_DLC.Config.Language = "ru" -- Set the language of the script.

-- General
CH_Bitminers_DLC.Config.NotificationTime = 5 -- Amount of seconds notifications will show.
