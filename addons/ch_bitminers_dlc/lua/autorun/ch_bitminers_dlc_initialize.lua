-- INITIALIZE SCRIPT
if SERVER then
	for k, v in pairs( file.Find( "ch_bitminers_dlc/shared/*.lua", "LUA" ) ) do
	...
	for k, v in pairs( file.Find( "ch_bitminers_dlc/server/*.lua", "LUA" ) ) do
		include( "ch_bitminers_dlc/server/" .. v )
		--print("server: ".. v)
	end
	
	for k, v in pairs( file.Find( "ch_bitminers_dlc/client/*.lua", "LUA" ) ) do
