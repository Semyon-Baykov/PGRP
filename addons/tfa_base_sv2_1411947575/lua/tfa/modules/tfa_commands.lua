...
if GetConVar("sv_tfa_fx_ejectionsmoke_override") == nil then
	CreateReplConVar("sv_tfa_fx_ejectionsmoke_override", "-1", "-1 to let clients pick.  0 to force off.  1 to force on.")
end

if GetConVar("sv_tfa_fx_muzzlesmoke_override") == nil then
	CreateReplConVar("sv_tfa_fx_muzzlesmoke_override", "-1", "-1 to let clients pick.  0 to force off.  1 to force on.")
end

if GetConVar("sv_tfa_fx_gas_override") == nil then
	CreateReplConVar("sv_tfa_fx_gas_override", "-1", "-1 to let clients pick.  0 to force off.  1 to force on.")
end

if GetConVar("sv_tfa_fx_impact_override") == nil then
	CreateReplConVar("sv_tfa_fx_impact_override", "-1", "-1 to let clients pick.  0 to force off.  1 to force on.")
end
