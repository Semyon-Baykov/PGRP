...
function EFFECT:Init(data)
	...
	self.OGWeaponEnt = self.WeaponEnt
	...
	if self.OGWeaponEnt.XTick == nil then
		self.OGWeaponEnt.XTick = 0
	end

	self.OGWeaponEnt.XTick = 1 - self.OGWeaponEnt.XTick

	if self.OGWeaponEnt.XTick == 1 then
	...
	if (sparticle) then
		...
		sparticle:SetStartAlpha(math.Rand(225, 255))
