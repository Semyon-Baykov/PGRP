...
hook.Add( 'loadCustomDarkRPItems', 'nrgars_load', function()
 tbl = {
    ...
    ['Комплект стрелка №1'] = {
        id = 1,
        desc = 'Бронежилет, АКС74, ПМ, и дубинка.',
	...
	['Комплект спецназа усиленный'] = {
		id = 10,
        desc = 'Специальный набор для спец операций: Бронежилет, АС-ВАЛ, ВСС Винторез, СВД, ПЛ-14, щит,\nи дубинка. В комлект также входят все виды гранат и бинокль.',
        wpns = {'stunstick',  'weapon_flashgrenade', 'weapon_fraggrenade', 'weapon_gas','weapon_rpw_binoculars',  'riot_shield',		'tfa_val', 'tfa_vss', 'tfa_pl14', 'tfa_dragunov'},
        armor = 100,
		access = 9
	}
 }
