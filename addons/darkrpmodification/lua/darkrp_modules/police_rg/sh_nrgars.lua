...
hook.Add( 'loadCustomDarkRPItems', 'nrgars_load', function()
 tbl = {
	...
	['Комплект спецназа №1'] = {
        ...
        wpns = {'tfa_akms', 'tfa_pl14', 'stunstick', 'weapon_nod_vant_vm', 'weapon_flashgrenade', 'weapon_fraggrenade'},
        armor = 100
	},
	...
	['Комплект спецназа №2'] = {
        ...
        wpns = {'tfa_aek971', 'tfa_pl14', 'stunstick', 'weapon_nod_vant_vm', 'weapon_gas', 'weapon_fraggrenade'},
        armor = 100
    },
	...
	['Комплект комендата'] = {
        ...
        wpns = {'tfa_vikhr','tfa_pm', 'stunstick', 'weapon_nod_vant_vm', 'weapon_rpt_stungun', 'weapon_rpt_handcuff', 'arrest_stick'},
        armor = 100
    },
	...
	['Комплект Маршала'] = {
        ...
        wpns = {'stunstick', 'arrest_stick', 'unarrest_stick', 'weapon_rpt_handcuff', 'weapon_rpt_stungun',		'weapon_flashgrenade', 'weapon_fraggrenade', 'weapon_gas',		'weapon_medkit', 'weapon_gpwrench', 'weapon_gpgascan', 'weapon_rpw_binoculars', 'weapon_nod_vant_vm',		'tfa_val', 'tfa_svu', 'tfa_pl14'},
        armor = 100,
		access = 20
	}
 }
...
hook.Add( 'loadCustomDarkRPItems', 'nrgars_load', function()
 tbl = {
	...
	['Комплект комендата'] = {
        ...
        wpns = {'tfa_vikhr','tfa_pm','stunstick','weapon_nod_vant_vm','arrest_stick','weapon_rpt_handcuff','weapon_rpt_stungun'},
        armor = 50
    },
	...
	['Комплект общественного порядка'] = {
        ...
        wpns = {'weapon_flashgrenade','weapon_gas','stunstick','weapon_nod_vant_vm'},
        armor = 100
    },
	...
	['[Premium] Комплект спецназа №1'] = {
        ...
        wpns = {'stunstick','weapon_nod_vant_vm', 'weapon_flashgrenade', 'tfa_akms', 'tfa_pl14', 'weapon_fraggrenade'},
        armor = 100
    },
	...
	['[Premium] Комплект спецназа №2'] = {
        ...
        wpns = {'stunstick','weapon_nod_vant_vm', 'weapon_flashgrenade', 'tfa_aek971', 'tfa_pl14', 'weapon_fraggrenade'},
        armor = 100
    },
