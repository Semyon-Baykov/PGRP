...
local terms_tbl = {
	...
	{
		term_pos = Vector(-1864.582153, 1583.690186, -347.032867),
		term_ang = Angle( 0,90,0 ),
		term_spawnpos = { Vector(-2233.167480, 1492.391479, -347.134979), Vector(-2219.818115, 1724.144165, -347.138885), Vector(-2214.944336, 1948.268311, -347.155548) },
		term_spawnang = Angle( 0, -113, 0 )
	},
	{
		term_pos = Vector(-13486.666016, -848.676208, -190.613876), //rg
		term_ang = Angle( 0,0,0 ),
		term_spawnpos = { Vector( -13450.881836, -521.630432, -193.591553 ), Vector( -13725.671875, -534.247253, -193.615738 ), Vector( -14017.625977, -564.797241, -193.598358 ) },
		term_spawnang = Angle( 0, 0, 0 )
	}
}
