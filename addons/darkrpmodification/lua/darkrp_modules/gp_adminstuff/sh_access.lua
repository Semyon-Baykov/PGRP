...
function meta:gp_WepAccess()
	...
	return self:GetUserGroup() == 'donsuperadmin' or self:GetUserGroup() == 'owner' or self:GetUserGroup() == 'superadmin' or self:GetUserGroup() == 'nab_admin' or self:GetUserGroup() == 'sponsor+'-- or self:GetUserGroup() == 'slavaukraine'

end

function meta:gp_VehAccess()

	return self:GetUserGroup() == 'superadmin' or self:GetUserGroup() == 'sponsor+' or self:GetUserGroup() == 'owner'
