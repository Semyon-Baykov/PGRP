...
GM.Config.F1MenuHelpPage = "https://drive.google.com/file/d/1AQHpTqMnBrN-EvcAV30gueoCMMF8b_hW/view?usp=sharing"
GM.Config.F1MenuHelpPageTitle = "Правила сервера"
...
GM.Config.DefaultLaws = {
		...
		"Во время комендантского часа граждане обязаны прибыть в свои дома в течение 1 минуты и не покидать их, если иное не указано в пояснении к комендантскому часу.",
...
GM.Config.hudText = "Нажмите E чтобы заказать убийство"
