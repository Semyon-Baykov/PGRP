...
function ENT:PrinterMenu()
	...
	Power.Paint = function(pnl, w, h)
		...
		--> Status
		if varPower == 0 then
			draw.DrawText('Status: OFF', 'FG_JaapokkiRegular_22', w/2, 66, Color(50, 50, 50, 255), 1)
		else
			draw.DrawText('Status: ON', 'FG_JaapokkiRegular_22', w/2, 66, Color(50, 50, 50, 255), 1)
		end
	...
	UpgradeInfo.Paint = function(pnl, w, h)
		...
		draw.DrawText('Premium Only', 'FG_JaapokkiRegular_22', (w/2-26)/2, 6, Color(30, 30, 30, 255), 1)

		draw.RoundedBox(4, w/2+6, 5, 20, 20, Color(0, 0, 0, 30))
		--draw.RoundedBox(4, w/2+10, 9, 20-8, 20-8, Color(231, 76, 60, 150))

		draw.DrawText('', 'FG_JaapokkiRegular_22', (w/2+6)*1.5, 6, Color(30, 30, 30, 255), 1)
