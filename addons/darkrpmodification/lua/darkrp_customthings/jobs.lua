local ass = {
	...
	['rp_krasnogorsk_pg_v2'] = {
		pos1 = Vector( -719.922791, 1341.749634, -188.381500 ),
		pos2 = Vector( -1856.731323, 1826.416992, 186.97187)
	},
}
...
TEAM_COCAINE = DarkRP.createJob("Продавец Кокаина", {
	color = Color(150, 150, 150, 255),
	model = {"models/player/corpse1.mdl"},
	description = [[Изготавливайте кокаин и продавайте его по большой цене. 

	НПС разбросаны по карте - один в лесу, один прямо рядом со спавном, и третий в подвалах.
	]],
	weapons = {'pass_ua'},
	command = "cocain",
	max = 4,
