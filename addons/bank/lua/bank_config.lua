BankRS_Config = {
	...
	["Interest"] = {
		...
		["Base_Reward"] = 349999, //The base amount of money without any interest available to rob from the bank.
		["Reward_Max"] = 350000, //As high as interest can make the reward go.
	},
	["Cooldown"] = {
