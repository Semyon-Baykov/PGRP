BankRS_Config = {
	...
	["Interest"] = {
		...
		["Base_Reward"] = 149999, //The base amount of money without any interest available to rob from the bank.
		["Reward_Max"] = 150000, //As high as interest can make the reward go.
	},
	["Cooldown"] = {
