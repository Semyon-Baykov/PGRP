...
surface.CreateFont("BankFont", {font = "Coolvetica", size = 85}) //I don't know why, but as long as this number is high the font looks fine!
function ENT:Draw()
    ...
    cam.Start3D2D(pos, ang, 0.15) 
		...
		if (self:GetNWString("Status") == "") then   
			draw.SimpleTextOutlined("Банковское хранилище", "BankFont", 0, -560, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 5, Color(0, 0, 0, 255))
		else
			draw.SimpleTextOutlined("Банковское хранилище", "BankFont", 0, -635, Color(255, 255, 255, 255), TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER, 5, Color(0, 0, 0, 255))
