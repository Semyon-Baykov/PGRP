...
-- Sound volume for all sounds of entities. (70 is okay)
EML_Sound_Volume = 70;
...
-- Salesman name.
EML_Meth_Salesman_Name = "Скупщик мета 'Борис'";
-- Salesman name color.
...
EML_Meth_Salesman_GotMeth = {
	"Ухх, хорошо пошло",
	"Уф.. Спасибо тебе",
	"Спасибо! Качественная продукция",
	"Да я тебя сейчас.. Копам сдам! Да ладно, не ссы.. Шутка! А за это спасибо"
	};	
-- Salesman phrases if player don't have meth.	
