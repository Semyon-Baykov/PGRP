...
function ENT:Initialize()
	...
	self.chair.pCasinoChairEnt = self
	-- A table we can use to store the user's enter pos
	self.enterPos = {}
end
...
function ENT:Use(ply)
	...
	-- Custom checks
	local canRun, failMsg = hook.Run("pCasinoCanChairSit", ply, self)
