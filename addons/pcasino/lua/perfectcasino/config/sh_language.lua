...
PerfectCasino.Translation.ToolGun.DeletePermissions = "ЭЭЭ ТЫ НЕ АДМИН!"
...
PerfectCasino.Translation.UI.Start = "Начало: %is"
PerfectCasino.Translation.UI.PlaceBet = "Поставить"
PerfectCasino.Translation.UI.Waiting = "Ждём"
PerfectCasino.Translation.UI.DoubleDown = "Удвоить"
PerfectCasino.Translation.UI.Split = "Разделить"
PerfectCasino.Translation.UI.Hit = "Ещё одну"
PerfectCasino.Translation.UI.Stand = "Остаться"
...
PerfectCasino.Translation.UI.CurrentHand = "Текущяя рука: %s"
PerfectCasino.Translation.UI.SpinThatWheel = "Крутаните!"
PerfectCasino.Translation.UI.ReadyToPlay = "Готовы к игре!"
PerfectCasino.Translation.UI.PurchaseASpin = "Крутаните!"
PerfectCasino.Translation.UI.FreeSpin = "Бесплатная прокрутка!"
PerfectCasino.Translation.UI.FreeSpinCount = "Бесплатная прокрутка: %s"
PerfectCasino.Translation.UI.Play = "Играть %s"
PerfectCasino.Translation.UI.LeaveSeat = "Зажмите E что бы встать"
PerfectCasino.Translation.UI.BetLimit = "Лимит ставки: %s"

-- Chat messages
PerfectCasino.Translation.Chat = {}
PerfectCasino.Translation.Chat.NoMoney = "У вас не достаточно денег!"
PerfectCasino.Translation.Chat.Payout = "Вы выиграли %s!"
PerfectCasino.Translation.Chat.RouletteFail = "Не одна из ваших ставок не окупилась!"
PerfectCasino.Translation.Chat.PayoutJackpot = "JACKPOT! %s!"
PerfectCasino.Translation.Chat.AlreadyPlaced = "Вы уже поставили ставку!"
PerfectCasino.Translation.Chat.BetPlaced = "Ваша ставка была поставлена!!"
PerfectCasino.Translation.Chat.HandBust = "Перебор! Вы проиграли вашу ставку!"
PerfectCasino.Translation.Chat.DealerHandBust = "У диллера перебор! Вы выиграли %s!"
...
PerfectCasino.Translation.Chat.SlotWheelSpin = "Вы крутанули и выиграли %s!"
PerfectCasino.Translation.Chat.UsedFreeSpin = "У вас бесплатная прокрутка!"
PerfectCasino.Translation.Chat.UsedPaidSpin = "Вы заплатили %s за прокрутку!"
PerfectCasino.Translation.Chat.BetLimit = "Вы больше не можете ставить в этом раунде!"
PerfectCasino.Translation.Chat.WillReachBetLimit = "Ваша ставка зашла за лимит (%s)"
PerfectCasino.Translation.Chat.LimitMachineUse = "Вы прыгаете с машину на машину слишком быстро!"
PerfectCasino.Translation.Chat.LimitMachineUsedByOther = "Подвинься! Я тоже хочу((("
