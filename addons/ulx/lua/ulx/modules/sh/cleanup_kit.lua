...
local infammo = ulx.command("Cleanup Kit", "ulx infammo", ulx.infammo, "!infammo")
...
local rocket = ulx.command("Cleanup Kit", "ulx rocket", ulx.rocket, "!rocket")
...
local BuddhaPlayers = {}
if SERVER then
	hook.Add("EntityTakeDamage","CLEANUPKIT.BuddhaTakeDamage",function(ent,dmginfo)
...
local buddha = ulx.command("Cleanup Kit", "ulx buddha", ulx.buddha, "!buddha")
...
if SERVER then
	util.AddNetworkString("CLEANUPKITi.ListJoinsDCs")
...
local cleardecals = ulx.command("Cleanup Kit", "ulx cleardecals", ulx.cleardecals, { '!decals', '!ragdolls', 'clearragdolls', "!cleardecals"} )
cleardecals:defaultAccess( ULib.ACCESS_ADMIN )
cleardecals:help( "Clears the decals and ragdolls." )
...
local stopsound = ulx.command("Cleanup Kit", "ulx stopsound", ulx.stopsound, { '!sounds', "!stopsound"})
...
local nolag = ulx.command("Cleanup Kit", "ulx nolag", ulx.nolag, "!nolag")
