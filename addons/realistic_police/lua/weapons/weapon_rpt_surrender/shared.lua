...
if CLIENT then
	function SWEP:DrawHUD()
		draw.SimpleTextOutlined(Realistic_Police.Lang[76][Realistic_Police.Langage].." ( Press "..Realistic_Police.SurrenderInfoKey.." )","rpt_font_9", ScrW()/2, ScrH()/15, Realistic_Police.Colors["white"], TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM,2, Realistic_Police.Colors["black"])
	end
end
