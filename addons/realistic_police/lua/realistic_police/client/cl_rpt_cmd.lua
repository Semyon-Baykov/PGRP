...
function Realistic_Police.Cmd(Frame, Ent)
    ...
    if not Realistic_Police.HackerJob[team.GetName(LocalPlayer():Team())] then RealisticPoliceNotify(Realistic_Police.Lang[42][Realistic_Police.Langage]) return end  
    local RPTValue = 0
    local RPTTarget = 300
    local speed = 10
    local TextHack = ""
