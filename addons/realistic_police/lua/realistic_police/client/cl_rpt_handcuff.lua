...
function Realistic_Police.Jailer(NamePlayer)
    ...
    RPTLFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Police.Lang[66][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.004, RpRespY*0.005, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
    ...
    DermaNumSlider.OnValueChanged = function( panel, value )
        DButtonAccept:SetText(Realistic_Police.Lang[48][Realistic_Police.Langage].." "..math.Round(value, 0).." "..Realistic_Police.Lang[78][Realistic_Police.Langage])
    end   
    ...
    RPTDPanel:SetText(Realistic_Police.Lang[21][Realistic_Police.Langage])
    RPTDPanel.Paint = function(self,w,h)
        ...
        surface.SetDrawColor( Realistic_Police.Colors["darkblue"] )
        surface.DrawOutlinedRect( 0, 0, w, h )
        draw.DrawText(Realistic_Police.Lang[67][Realistic_Police.Langage].." : "..NamePlayer, "rpt_font_7", RpRespX*0.005, RpRespY*0.014, Realistic_Police.Colors["white"], TEXT_ALIGN_LEFT)
    end
    ...
    PanelCT.OnGetFocus = function(self) 
        if PanelCT:GetText() == " "..Realistic_Police.Lang[5][Realistic_Police.Langage] then  
            PanelCT:SetText("") 
        end
    end 
...
function Realistic_Police.Bailer(RPTTable)
    ...
    RPTLFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Police.Lang[71][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.003, RpRespY*0.005, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
    ...
    for k,v in pairs(RPTTable) do 
        ...
        RPTDPanel2.Paint = function(self,w,h)
            ...
            surface.DrawRect( 0, 0, w, h )
            draw.SimpleText(Realistic_Police.Lang[67][Realistic_Police.Langage].." : "..v.vName, "rpt_font_9", RpRespX*0.06, RpRespY * 0.012, Realistic_Police.Colors["gray220"], TEXT_ALIGN_LEFT)
            draw.SimpleText(Realistic_Police.Lang[69][Realistic_Police.Langage].." : "..v.vMotif, "rpt_font_9", RpRespX*0.06, RpRespY * 0.039, Realistic_Police.Colors["gray220"], TEXT_ALIGN_LEFT)
            draw.SimpleText(Realistic_Police.Lang[68][Realistic_Police.Langage].." : "..DarkRP.formatMoney(v.vPrice), "rpt_font_9", RpRespX*0.06, RpRespY * 0.066, Realistic_Police.Colors["gray220"], TEXT_ALIGN_LEFT)
        end 
        ...
        RPTButtonPay:SetText(Realistic_Police.Lang[70][Realistic_Police.Langage])
...
function Realistic_Police.CheckPlayer(Player, Table)
    ...
    RPTLFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Police.Lang[74][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.003, RpRespY*0.005, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
        ...
        if v["ModelW"] != "" then 
            if not Realistic_Police.CantConfiscate[v["ClassW"]] then 
                ...
                DButton1.PaintOver = function(self, w, h)
                    surface.SetDrawColor( Realistic_Police.Colors["black15"] )
                    surface.DrawRect( 0, 0, w, h )
                    draw.DrawText(Realistic_Police.Lang[75][Realistic_Police.Langage], "rpt_font_7", w/2, h/8, Realistic_Police.Colors["white"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                end 
