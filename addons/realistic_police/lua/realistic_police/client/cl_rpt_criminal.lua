            ...
            if istable(RPTCriminalRecord) then 
                for k,v in pairs(RPTCriminalRecord) do 
                    ...
                    DButton2.DoClick = function()
                        if Realistic_Police.JobDeleteRecord[team.GetName(LocalPlayer():Team())] then  
                            if p != LocalPlayer() then 
                                ...
                                RealisticPoliceNotify(Realistic_Police.Lang[85][Realistic_Police.Langage])
                            end 
                        else 
...
function Realistic_Police.CriminalRecord()
    ...
    RPTCFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Police.Lang[1][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.003, RpRespY*0.0038, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
    ...
    DPanel.Paint = function(self,w,h)
        ...
        surface.SetDrawColor(Realistic_Police.Colors["gray60"])
        surface.DrawOutlinedRect( 0, 0, w, h )
        draw.DrawText(Realistic_Police.Lang[2][Realistic_Police.Langage].." : "..CrimeRecordName, "rpt_font_7", RpRespX*0.01, RpRespY*0.015, Realistic_Police.Colors["gray"], TEXT_ALIGN_LEFT)
    end 
    ...
    BAdd:SetText(Realistic_Police.Lang[4][Realistic_Police.Langage])
    ...
    BAdd.DoClick = function()
        ...
        PanelCD:SetText(Realistic_Police.Lang[3][Realistic_Police.Langage])
        ...
        ButtonAdd:SetText(Realistic_Police.Lang[6][Realistic_Police.Langage])
        ...
        ButtonAdd.DoClick = function()
            if RPTActivate && IsValid(RPTCriminalP) then 
                if PanelCT:GetText() != " "..Realistic_Police.Lang[5][Realistic_Police.Langage] then 
                    if Realistic_Police.JobEditRecord[team.GetName(LocalPlayer():Team())] then 
                        net.Start("RealisticPolice:CriminalRecord")
                            net.WriteUInt(1, 10)
        ...
        ButtonDel:SetText(Realistic_Police.Lang[7][Realistic_Police.Langage])
