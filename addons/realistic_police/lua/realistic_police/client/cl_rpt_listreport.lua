...
function Realistic_Police.ListReport(RPTFrame)
    ...
    RPTLFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Police.Lang[21][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.003, RpRespY*0.005, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
    ...
    RPTComboBox:SetText(Realistic_Police.Lang[21][Realistic_Police.Langage])
    ...
    RPTComboBox:AddChoice( Realistic_Police.Lang[12][Realistic_Police.Langage] )
                ...
                if istable(RPTTableListReport) then 
                    for k,v in pairs(RPTTableListReport) do 
                        ...
                        RPTDPanel2.Paint = function(self,w,h)
                            ...
                            surface.DrawRect( 0, 0, w, h )
                            draw.SimpleText(Realistic_Police.Lang[17][Realistic_Police.Langage].." : "..v.RPTPolice, "rpt_font_9", RpRespX*0.06, RpRespY * 0.012, Realistic_Police.Colors["gray220"], TEXT_ALIGN_LEFT)
                            draw.SimpleText(Realistic_Police.Lang[18][Realistic_Police.Langage].." : "..v.RPTCriminal, "rpt_font_9", RpRespX*0.06, RpRespY * 0.039, Realistic_Police.Colors["gray220"], TEXT_ALIGN_LEFT)
                            draw.SimpleText(Realistic_Police.Lang[19][Realistic_Police.Langage].." : "..v.RPTDate, "rpt_font_9", RpRespX*0.06, RpRespY * 0.066, Realistic_Police.Colors["gray220"], TEXT_ALIGN_LEFT)
                        end 
                        ...
                        RPTButtonRead:SetText(Realistic_Police.Lang[20][Realistic_Police.Langage])
