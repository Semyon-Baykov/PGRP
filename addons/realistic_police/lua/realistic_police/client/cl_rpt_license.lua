...
function Realistic_Police.License()
    ...
    RPTLFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Police.Lang[8][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.003, RpRespY*0.002, Color(220, 220, 220, RPTValue), TEXT_ALIGN_LEFT)
    end 
    ...
    RPTEntry:SetText(Realistic_Police.Lang[8][Realistic_Police.Langage])
    ...
    RPTAccept:SetText(Realistic_Police.Lang[9][Realistic_Police.Langage])
    ...
    RPTAccept.DoClick = function()
        ...
        if istable(Realistic_Police.GetVehicleLicense(RPTEntry:GetValue())) && #Realistic_Police.GetVehicleLicense(RPTEntry:GetValue()) > 0 then 
            ...
            RPTLFrame.Paint = function(self,w,h)
                ...
                draw.DrawText(Realistic_Police.Lang[8][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.005, RpRespY*0.002, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
            end 
            ...
            RPTEntry:SetText(Realistic_Police.Lang[10][Realistic_Police.Langage])
