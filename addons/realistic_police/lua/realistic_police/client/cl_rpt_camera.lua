...
function Realistic_Police.OpenCamera(RPTListCamera)
    ...
    RPTCFrame.Paint = function(self,w,h)
        ...
        draw.DrawText(Realistic_Police.Lang[38][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.003, RpRespY*0.0038, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
    ...
    DPanel.Paint = function(self,w,h)
        ...
        surface.SetDrawColor( Realistic_Police.Colors["gray60"] )
        surface.DrawOutlinedRect( 0, 0, w, h )
        draw.DrawText(Realistic_Police.Lang[39][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.01, RpRespY*0.014, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
                ...
                if not RPTListCamera[RPTId]:GetRptCam() then 
                    ...
                    if not IsValid(DPanelBroke) then 
                        ...
                        DPanelBroke.Paint = function(self,w,h)
                            ...
                            draw.SimpleText(Realistic_Police.Lang[43][Realistic_Police.Langage], "rpt_font_12", DPanelBroke:GetWide()/2, DPanelBroke:GetTall()/2.5, Realistic_Police.Colors["white"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                            draw.SimpleText(Realistic_Police.Lang[44][Realistic_Police.Langage], "rpt_font_13", DPanelBroke:GetWide()/2, DPanelBroke:GetTall()/1.8, Realistic_Police.Colors["red"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
                        end 
                    end 
                end 
            end 
...
function Realistic_Police.FulLScreenCamera(RPTListCamera)
    ...
    RPTCFrame.Paint = function(self,w,h)
        ...
        surface.SetDrawColor( Realistic_Police.Colors["black15200"] )
        surface.DrawOutlinedRect( 0, 0, w, h )
        draw.DrawText(Realistic_Police.Lang[38][Realistic_Police.Langage], "rpt_font_7", RpRespX*0.008, RpRespY*0.01, Color(Realistic_Police.Colors["gray220"].r, Realistic_Police.Colors["gray220"].g, Realistic_Police.Colors["gray220"].b, RPTValue), TEXT_ALIGN_LEFT)
    end 
    ...
    timer.Simple(0.2, function()
        ...
        DScroll2.Paint = function(self,w,h)  
            surface.SetDrawColor( Realistic_Police.Colors["black49255"] )
            surface.DrawRect( 0, 0, w, h )
            local x,y = self:LocalToScreen(0, 0)

            if #RPTListCamera != 0 or not IsValid(RPTListCamera[RPTId]) then return end 
            ...
            if not RPTListCamera[RPTId]:GetRptCam() then 
                ...
                if not IsValid(DPanelBroke) then 
                    DPanelBroke = vgui.Create("DPanel", DScroll2)
                    DPanelBroke:SetSize(RpRespX*0.63, RpRespY*0.69)
                    DPanelBroke:SetPos(RpRespX*0.005, RpRespY*0.008)
                    DPanelBroke.Paint = function(self,w,h)
                        surface.SetDrawColor( Realistic_Police.Colors["black20"] )
                        surface.DrawRect( 0, 0, w, h )
                        draw.SimpleText(Realistic_Police.Lang[43][Realistic_Police.Langage], "rpt_font_12", DPanelBroke:GetWide()/2, DPanelBroke:GetTall()/2.5, Realistic_Police.Colors["white"], TEXT_ALIGN_CENTER, TEXT_ALIGN_CENTER)
