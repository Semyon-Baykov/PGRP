...
SWEP.PrintName = "Фруктовый"

SWEP.Instructions = "Выбирайте любой вкус и цвет!"
...
JuicyVapeJuices = {
	{name = '"Маунтай дью"', color = Color(150,255,100,255)},
	{name = '"Читос"', color = Color(255,180,100,255)},
	{name = '"Разлберри"', color = Color(250,100,200,255)},
	{name = '"Банан"', color = Color(255,255,100,255)},
	{name = '"Чёрный ликёр"', color = Color(40,40,40,255)},
	{name = '"Чурро"', color = Color(210,180,140,255)},
	{name = '"Скитлс"', color = nil}, --nil means rainbow
}
