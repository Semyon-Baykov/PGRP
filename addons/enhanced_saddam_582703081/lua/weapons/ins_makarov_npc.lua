...
sound.Add({	name		= "INS1on_Makarov.Single",
	channel		= CHAN_WEAPON,
	volume		= 1.0,
	level		= 140,
	pitch		= { 95, 105 },
...
if (CLIENT) then
	local	_SELFENTNAME	= "ins_makarov"
	local	_INFONAME		= "PMM"
...
SWEP.WorldModel				= Model("models/weapons/ins_makarovp_w.mdl")
SWEP.MuzzleAttachment		= "1"
SWEP.Base 					= "npc_pyrous_gun_base"
SWEP.Spawnable				= false
SWEP.AdminOnly				= true

SWEP.Primary.Sound			= Sound( "INS1on_Makarov.Single" )
SWEP.Primary.RPM			= 692
