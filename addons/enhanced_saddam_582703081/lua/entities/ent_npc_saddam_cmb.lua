...
function ENT:Initialize()
	...
	self.ent1:SetModel("models/jessev92/kuma/characters/saddam_npccmb.mdl" )
	...
	if GetConVarNumber( "npcg_squad_combine" ) != 0	then
		self.ent1:SetKeyValue( "SquadName", "TerroristsE" )
	end
	...
	undo.Create("Saddam (Enemy)")
		undo.AddEntity(self.ent1)
		undo.SetCustomUndoText("Undone Saddam (Enemy)")
