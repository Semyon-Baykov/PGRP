...
function ENT:Initialize()
	...
	self.ent1:SetModel("models/jessev92/kuma/characters/saddam_npccit.mdl" )
	...
	if GetConVarNumber( "npcg_squad_human" ) != 0	then
		self.ent1:SetKeyValue( "SquadName", "TerroristsF" )
	end
	...
	undo.Create("Saddam (Friendly)")
		undo.AddEntity(self.ent1)
		undo.SetCustomUndoText("Undone Saddam (Friendly)")
