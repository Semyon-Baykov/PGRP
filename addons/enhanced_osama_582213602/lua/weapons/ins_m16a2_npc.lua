...
if CLIENT then
	...
	local	_SELFENTNAME		= "ins_m16a2"
	local	_INFONAME			= "M16A2"
...
SWEP.WorldModel				= Model("models/weapons/ins_m16a2_w.mdl")
SWEP.MuzzleAttachment		= "1"
SWEP.Base 					= "npc_pyrous_gun_base" --the Base this weapon will work on. PLEASE RENAME THE BASE!
SWEP.Spawnable				= false
SWEP.AdminOnly				= true

SWEP.Primary.Sound			= Sound( "INS1on_M16A4.Single" )
...
SWEP.Primary.Ammo			= "556x45mmnato"
