...
derma.DefineControl( "ULogs_DCheckBox", "Simple Checkbox", PANEL, "ULogs_DButton" )
...
function PANEL:Init()
	...
	self:SetTall( 16 )
	self.Button = vgui.Create( "ULogs_DCheckBox", self )
...
derma.DefineControl( "ULogs_DCheckBoxLabel", "Simple Checkbox", PANEL, "DPanel" )