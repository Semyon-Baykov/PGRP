...
derma.DefineControl( "ULogs_DListViewHeaderLabel", "", PANEL, "DLabel" )
...
derma.DefineControl( "ULogs_DListView_DraggerBar", "", PANEL, "DButton" )
...
function PANEL:Init()
	...
	self.Header = vgui.Create( "ULogs_GDButton", self )
	self.Header.DoClick = function() self:DoClick() end
	self.Header.DoRightClick = function() self:DoRightClick() end
	
	self.DraggerBar = vgui.Create( "ULogs_DListView_DraggerBar", self )
...
derma.DefineControl( "ULogs_DListView_Column", "", table.Copy( PANEL ), "Panel" )
...
function PANEL:Init()
	...
	self.Header = vgui.Create( "ULogs_DListViewHeaderLabel", self )
...
derma.DefineControl( "ULogs_DListView_ColumnPlain", "", PANEL, "Panel" )