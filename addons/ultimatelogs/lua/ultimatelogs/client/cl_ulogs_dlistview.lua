...
function PANEL:Init()
	...
	self.VBar = vgui.Create( "ULogs_DVScrollBar", self )
...
function PANEL:AddColumn( strName, iPosition )
	...
	pColumn = vgui.Create( "ULogs_DListView_Column", self )
...
function PANEL:AddLine( ... )
	...
	local Line = vgui.Create( "ULogs_DListView_Line", self.pnlCanvas )
...
derma.DefineControl( "ULogs_DListView", "Data View", PANEL, "DPanel" )