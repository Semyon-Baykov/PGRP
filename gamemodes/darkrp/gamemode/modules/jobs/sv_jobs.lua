util.AddNetworkString( 'DarkRP_OnChangedTeam' )
...
function meta:changeTeam(t, force, suppressNotification, ignoreMaxMembers)
    ...
    if not force then
        ...
        self:gp_VipAccess() == false and max ~= 0 and -- No limit -- No limit
    ...
    net.Start( 'DarkRP_OnChangedTeam' )
        net.WriteInt( prevTeam, 8 )
        net.WriteInt( t, 8 )
    net.Send( self )
