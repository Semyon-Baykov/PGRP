util.AddNetworkString( 'DarkRP_DoVote' )
util.AddNetworkString( 'DarkRP_KillVoteVGUI' )
...
function DarkRP.createVote(question, voteType, target, time, callback, excludeVoters, fail, extraInfo)
    ...
    net.Start( 'DarkRP_DoVote' )
        net.WriteString( question )
        net.WriteInt( newvote.id , 7 )
        net.WriteFloat( time )
